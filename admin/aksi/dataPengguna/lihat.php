...
$stmt = $koneksi->prepare("SELECT id_pengguna,no_kk,nik,nama,tempat_lahir,tanggal_lahir,jenis_kelamin,alamat,rt,rw,kelurahan,kecamatan,agama,status_perkawinan,pekerjaan,kewarganegaraan FROM pengguna ORDER BY id_pengguna DESC");
