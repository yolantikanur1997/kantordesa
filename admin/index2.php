...
<html lang="en">
  <head>
    ...
    <title>PT Jiwa Properti - Marketing</title>
  ...
  <body class="nav-md" style="background:  #34103d;">
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col" style="border: 0; background:  #34103d;">
          <div class="left_col scroll-view"  style="background:  #34103d;">
            <div class="navbar nav_title" style="border: 0; background:  #34103d;" >
              <a href="index.html" class="site_title"><img src="../style/img/logo.png" width="50" height="50"><span>Marketing</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-building"></i> Rumah <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.php?page=Tipe">Tipe Rumah</a></li>
                      <li><a href="index.php?page=Fasilitas">Fasilitas Umum</a></li>
                      <li><a href="index.php?page=Rumah">Informasi Rumah</a></li>
                    </ul>
                  </li>
                  <li><a href="index.php?page=Pemesanan"><i class="fa fa-building"></i> Pemesanan Rumah </a></li>
                  <li><a href="index.php?page=Konsumen"><i class="fa fa-money"></i> Uang Muka </a></li>
                </ul>
              </div>
            </div>
          </div>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  ...
                  <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item"  href="../config/_logout.php"><i class="fa fa-sign-out pull-right"></i> Keluar</a>
                  </div>
                </li>
              </ul>
            </nav>
        ...
        <div class="card-body">
               <?php include 'view/dashboardFoto.php';?>
                </div>
