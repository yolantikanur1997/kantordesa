  ...
  <body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="dashboard.php?page=Pengguna">
                    <i class="fas fa-fw fa-users"></i>
                    <span>Pengguna</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="dashboard.php?page=Jenis-Surat">
                    <i class="fas fa-fw fa-envelope"></i>
                    <span>Jenis Surat</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="dashboard.php?page=Berkas">
                    <i class="fas fa-fw fa-book"></i>
                    <span>Berkas</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="dashboard.php?page=Pengajuan-Surat">
