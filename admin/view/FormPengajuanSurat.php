...
<div class="card shadow mb-4">
        <div class="card-header py-3">
          <div class="row">
           ...
           <a href="dashboard.php?page=Pengajuan-Surat"><button class="btn btn-primary" title="Segarkan"><i class="fas fa-fw fa-retweet"></i></button></a>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12">
                     ...
                     <div class="col-lg-12 col-md-12 col-sm-12">
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="tanggal_pengajuan" name="tanggal_pengajuan"  required="required">
                      </div>
                    </div>
                     <div class="col-lg-12 col-md-12 col-sm-12">
                      <div class="form-group">
                        <label>Tanggal Selesai</label>
                        <input type="date" class="form-control" id="tanggal_selesai" name="tanggal_selesai"  required="required">
                      </div>
                    </div>
                      <div class="col-lg-12 col-md-12 col-sm-12">
                      <div class="form-group">
                     ...
                     <div class="col-lg-12 col-md-12 col-sm-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="komentar" name="komentar"  required="required"></textarea>
                      </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12">
                     <div class="form-group">
                        <label>Status</label>
                        <select id="status" name="status" class="theSelect form-control">
