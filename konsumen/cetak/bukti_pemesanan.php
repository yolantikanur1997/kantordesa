...
if ($_SERVER['REQUEST_METHOD'] == 'GET'){
    ...
    $sql = "SELECT pemesanan_rumah.id_pemesanan,pemesanan_rumah.jml_uang_pemesanan_rumah,pemesanan_rumah.tgl_pesan_rumah,informasi_rumah.alamat_rumah,informasi_rumah.blok_rumah,informasi_rumah.no_rumah,tipe_rumah.tipe_rumah,konsumen.nama_konsumen,konsumen.no_hp
      FROM pemesanan_rumah, bukti_transfer, informasi_rumah, tipe_rumah, konsumen WHERE pemesanan_rumah.id_pemesanan = bukti_transfer.id_pemesanan 
      AND pemesanan_rumah.id_rumah = informasi_rumah.id_rumah AND informasi_rumah.id_tipe = tipe_rumah.id_tipe AND pemesanan_rumah.id_konsumen = konsumen.id_konsumen AND pemesanan_rumah.id_pemesanan = $id_pemesanan";
