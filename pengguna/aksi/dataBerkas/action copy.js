        ...
        if ($("#formBerkas").valid()) {
            ...
            } else
            {
                ...
                formData.append('fileupload', fileupload);
                 ...
                 _url = 'aksi/dataBerkas/edit.php';
                _data =  formData + "& id_berkas="+id_berkas;
                _method = 'POST';
            }
                    ...
                    "aoColumns": [
                     {
                        ...
                        },
                        {
                            ...
                            "mData": "id_berkas",
                            "render": function(mData, type, row, meta){
                                return'<button class="btn btn-xs btn-warning" title="Hapus" onclick="ambil('+mData+')"><i class="fa fa-edit"></i></button><button class="btn btn-xs btn-danger" title="Hapus" onclick="hapus('+mData+')"><i class="fa fa-trash"></i></button>';
                            }
