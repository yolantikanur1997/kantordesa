...
<body class="LoginForm">
      ...
      <div class="card">
        <div class="card-header">
           <i class="fa fa-users mr-auto"></i> Form Login Admin<br><br>
        ...
        <div class="card-body">
          <form action="config/_loginAdmin.php" method="POST">
            <div class="row">
        ...
        <input type="text" class="form-control" id="username" name="username" placeholder="Username" aria-describedby="inputGroupPrepend" required="required">
      	</div>
        </div>
           <div class="col-lg-12 col-md-12 col-sm-12">
